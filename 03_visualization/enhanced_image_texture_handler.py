...
class EnhancedImageTextureHandler:
    ...
    def _load_images(self):
        ...
        image_files = {
            ...
            'E_pair': 'moduleE1.png',
            'E_single': 'moduleEsingle.png',
            'F1': 'moduleF1.png',
            'F_single': 'moduleFsingle.png',
            'G': 'moduleGsingle.png',
            'G_single': 'moduleGsingle.png'
        }
    ...
    def get_module_image_key(self, module_name: str, group_index: int = 0, group_type: str = None,
        ...
        if module_name == 'A':
            ...
            # D0 是原有 2x1 紧密镜像组团，D1 是新的 2x2 大组团
            if group_type == 'D1':
                return 'D1'
            if group_type == 'D0':
                return 'D0'
            ...
            if group_type == 'E_pair':
                return 'E_pair'
            if group_type == 'E_single':
                return 'E_single'
            return 'E_single'
        elif module_name == 'F':
            if group_type == 'F1':
    ...
    def get_available_images(self) -> Dict[str, bool]:
        ...
        return {
            ...
            'moduleD0': 'D0' in self.images,
            'moduleD1': 'D1' in self.images,
            'moduleDsingle': 'D_single' in self.images,
            'moduleE1': 'E_pair' in self.images,
            'moduleEsingle': 'E_single' in self.images,
            'moduleF1': 'F1' in self.images,
            'moduleFsingle': 'F_single' in self.images,
            'moduleGsingle': 'G_single' in self.images
        }
